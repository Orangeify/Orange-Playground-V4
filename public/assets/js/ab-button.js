(function(){
  ...
  function openAboutBlankSelf(){
    ...
    const html = `<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>My Drive</title><style>html,body,iframe{height:100%;margin:0}iframe{border:0;width:100%;height:99%;}</style></head><body><iframe src="${src}" sandbox="allow-same-origin allow-scripts allow-forms allow-popups"></iframe></body></html>`;
